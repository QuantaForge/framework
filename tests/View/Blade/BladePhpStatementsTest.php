...
class BladePhpStatementsTest extends AbstractBladeTestCase
{
    ...
    public function testStringWithParenthesisCanBeCompiled()
    {
        ...
        $this->assertSame('<?php echo $__env->make(\'test_for\', [\'issue))\' => \'(issue#45424))\'], \QuantaQuirk\Support\Arr::except(get_defined_vars(), [\'__data\', \'__path\']))->render(); ?>', $this->compiler->compileString('@include(\'test_for\', [\'issue))\' => \'(issue#45424))\'])'));
        $this->assertSame('( <?php echo $__env->make(\'test_for\', [\'not_too_much))\' => \'(issue#45424))\'], \QuantaQuirk\Support\Arr::except(get_defined_vars(), [\'__data\', \'__path\']))->render(); ?>))', $this->compiler->compileString('( @include(\'test_for\', [\'not_too_much))\' => \'(issue#45424))\'])))'));
    }
    ...
    public function testUnclosedParenthesisForBladeTags()
    {
        ...
        $expected = "<span class=\"<?php echo \QuantaQuirk\Support\Arr::toCssClasses([]); ?>\"(['(']></span>";
    ...
    public function testNestedTagCalls()
    {
        ...
        $expected = '<span class="<?php echo \QuantaQuirk\Support\Arr::toCssClasses([\'k\' => @empty($v)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
        ...
        $expected = '<span class="<?php echo \QuantaQuirk\Support\Arr::toCssClasses([\'k\' => @empty($v), \'t\' => @empty($v1)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
        ...
        $expected = '<span class="<?php echo \QuantaQuirk\Support\Arr::toCssClasses([\'k\' => @empty($v), \'t\' => @empty($v1), \'r\' => @empty($v2)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
        ...
        $expected = '<span class="<?php echo \QuantaQuirk\Support\Arr::toCssClasses([\'k\' => @empty($v), \'t\' => @empty($v1), \'r\' => @empty($v2), \'l\' => \'l\']); ?>"></span><span class="<?php echo \QuantaQuirk\Support\Arr::toCssClasses([\'k\' => @empty($v)]); ?>"></span>';
        $this->assertEquals($expected, $this->compiler->compileString($string));
    }
