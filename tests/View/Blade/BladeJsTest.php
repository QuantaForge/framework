...
class BladeJsTest extends AbstractBladeTestCase
{
    public function testStatementIsCompiledWithoutAnyOptions()
    {
        ...
        $expected = '<div x-data="<?php echo \QuantaQuirk\Support\Js::from($data)->toHtml() ?>"></div>';
    ...
    public function testJsonFlagsCanBeSet()
    {
        ...
        $expected = '<div x-data="<?php echo \QuantaQuirk\Support\Js::from($data, JSON_FORCE_OBJECT)->toHtml() ?>"></div>';
    ...
    public function testEncodingDepthCanBeSet()
    {
        ...
        $expected = '<div x-data="<?php echo \QuantaQuirk\Support\Js::from($data, JSON_FORCE_OBJECT, 256)->toHtml() ?>"></div>';
