...
use QuantaQuirk\Foundation\Exceptions\RegisterErrorViewPaths;
...
class DownCommand extends Command
{
    ...
    public function handle()
    {
        try {
            ...
            $this->quantaquirk->maintenanceMode()->activate($this->getDownFilePayload());
            ...
            $this->quantaquirk->get('events')->dispatch(new MaintenanceModeEnabled());
    ...
    {
        try {
            return $this->quantaquirk->make(PreventRequestsDuringMaintenance::class)->getExcludedPaths();
        } catch (Throwable) {
            return [];
        }
    }
