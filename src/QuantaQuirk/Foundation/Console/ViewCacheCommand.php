...
class ViewCacheCommand extends Command
{
     ...
     *
     * @param  \QuantaQuirk\Support\Collection  $views
     * @return void
     */
    protected function compileViews(Collection $views)
    {
        $compiler = $this->quantaquirk['view']->getEngineResolver()->resolve('blade')->getCompiler();
    ...
    {
        $extensions = collect($this->quantaquirk['view']->getExtensions())
    ...
    {
        $finder = $this->quantaquirk['view']->getFinder();
