...
use QuantaQuirk\Foundation\Events\PublishingStubs;
...
class StubPublishCommand extends Command
{
    ...
    {
        if (! is_dir($stubsPath = $this->quantaquirk->basePath('stubs'))) {
        ...
        $this->quantaquirk['events']->dispatch($event = new PublishingStubs($stubs));
