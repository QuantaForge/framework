...
class ChannelListCommand extends Command
{
     ...
     *
     * @param  \QuantaQuirk\Contracts\Broadcasting\Broadcaster
     * @return void
     */
    public function handle(Broadcaster $broadcaster)
    {
        ...
        if (! $this->quantaquirk->providerIsLoaded('App\Providers\BroadcastServiceProvider') &&
            file_exists($this->quantaquirk->path('Providers/BroadcastServiceProvider.php'))) {
     ...
     *
     * @param  \QuantaQuirk\Support\Collection  $channels
     * @return array
     */
