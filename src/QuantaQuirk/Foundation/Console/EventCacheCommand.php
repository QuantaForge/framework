...
use QuantaQuirk\Foundation\Support\Providers\EventServiceProvider;
...
class EventCacheCommand extends Command
{
    ...
    public function handle()
    {
        ...
        file_put_contents(
            $this->quantaquirk->getCachedEventsPath(),
    ...
    protected function getEvents()
    {
        ...
        foreach ($this->quantaquirk->getProviders(EventServiceProvider::class) as $provider) {
