...
use QuantaQuirk\Testing\Constraints\CountInDatabase;
use QuantaQuirk\Testing\Constraints\HasInDatabase;
use QuantaQuirk\Testing\Constraints\NotSoftDeletedInDatabase;
use QuantaQuirk\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param  \QuantaQuirk\Database\Eloquent\Model|string  $table
     * @param  array  $data
     ...
     * @return \QuantaQuirk\Contracts\Database\Query\Expression
     */
     ...
     *
     * @param  \QuantaQuirk\Database\Eloquent\Model|string  $table
     * @return \QuantaQuirk\Database\Eloquent\Model|null
     */
