...
use QuantaQuirk\Contracts\Http\Kernel as HttpKernel;
use QuantaQuirk\Cookie\CookieValuePrefix;
use QuantaQuirk\Http\Request;
use QuantaQuirk\Testing\LoggedExceptionCollection;
...
trait MakesHttpRequests
{
     ...
     *
     * @var \QuantaQuirk\Testing\TestResponse|null
     */
     ...
     * @param  string  $uri
     * @param  array  $headers
     * @return \QuantaQuirk\Testing\TestResponse
     */
     ...
     *
     * @param  \QuantaQuirk\Http\Response|\QuantaQuirk\Testing\TestResponse  $response
     * @return \QuantaQuirk\Http\Response|\QuantaQuirk\Testing\TestResponse
     */
