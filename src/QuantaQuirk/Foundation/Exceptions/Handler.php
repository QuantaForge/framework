...
use QuantaQuirk\Console\View\Components\BulletList;
use QuantaQuirk\Console\View\Components\Error;
...
class Handler implements ExceptionHandlerContract
{
     ...
     *
     * @var \QuantaQuirk\Foundation\Exceptions\ReportableHandler[]
     */
    ...
    protected function shouldntReport(Throwable $e)
    {
        ...
        return rescue(fn () => with($this->throttle($e), function ($throttle) use ($e) {
            ...
            return ! $this->container->make(RateLimiter::class)->attempt(
                with($throttle->key ?: 'quantaquirk:foundation:exceptions:'.$e::class, fn ($key) => $this->hashThrottleKeys ? md5($key) : $key),
     ...
     *
     * @param  \Throwable  $e
     * @return \QuantaQuirk\Support\Lottery|\QuantaQuirk\Cache\RateLimiting\Limit|null
     */
     ...
     * @param  \QuantaQuirk\Http\Request  $request
     * @param  \Throwable  $e
     * @return \QuantaQuirk\Http\Response|\QuantaQuirk\Http\JsonResponse|\QuantaQuirk\Http\RedirectResponse
     */
     ...
     *
     * @param  \QuantaQuirk\Http\Request  $request
     * @param  \QuantaQuirk\Auth\AuthenticationException  $exception
     * @return \QuantaQuirk\Http\Response|\QuantaQuirk\Http\JsonResponse|\QuantaQuirk\Http\RedirectResponse
     */
     ...
     *
     * @param  \QuantaQuirk\Validation\ValidationException  $e
     * @param  \QuantaQuirk\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \QuantaQuirk\Http\Request  $request
     * @param  \QuantaQuirk\Validation\ValidationException  $exception
     * @return \QuantaQuirk\Http\Response|\QuantaQuirk\Http\JsonResponse|\QuantaQuirk\Http\RedirectResponse
     */
    ...
    protected function prepareResponse($request, Throwable $e)
    {
        if (! $this->isHttpException($e) && config('app.debug')) {
            return $this->toQuantaQuirkResponse($this->convertExceptionToResponse($e), $e)->prepare($request);
        }
        ...
        return $this->toQuantaQuirkResponse(
    ...
    /**
     * Map the given exception into an QuantaQuirk response.
     *
     * @param  \Symfony\Component\HttpFoundation\Response  $response
     * @param  \Throwable  $e
     * @return \QuantaQuirk\Http\Response|\QuantaQuirk\Http\RedirectResponse
     */
    protected function toQuantaQuirkResponse($response, Throwable $e)
    {
