...
use QuantaQuirk\Contracts\Broadcasting\Factory as BroadcastFactory;
use QuantaQuirk\Contracts\Bus\Dispatcher;
use QuantaQuirk\Contracts\Cookie\Factory as CookieFactory;
...
use QuantaQuirk\Foundation\Bus\PendingClosureDispatch;
use QuantaQuirk\Foundation\Bus\PendingDispatch;
...
if (! function_exists('abort')) {
     ...
     *
     * @param  \Symfony\Component\HttpFoundation\Response|\QuantaQuirk\Contracts\Support\Responsable|int  $code
...
if (! function_exists('app')) {
     ...
     * @return \QuantaQuirk\Contracts\Foundation\Application|\QuantaQuirk\Foundation\Application|mixed
     */
...
if (! function_exists('auth')) {
     ...
     * @return \QuantaQuirk\Contracts\Auth\Factory|\QuantaQuirk\Contracts\Auth\Guard|\QuantaQuirk\Contracts\Auth\StatefulGuard
     */
...
if (! function_exists('broadcast')) {
     ...
     * @return \QuantaQuirk\Broadcasting\PendingBroadcast
     */
...
if (! function_exists('cache')) {
     ...
     * @return mixed|\QuantaQuirk\Cache\CacheManager
     *
...
if (! function_exists('config')) {
     ...
     * @param  mixed  $default
     * @return mixed|\QuantaQuirk\Config\Repository
     */
...
if (! function_exists('cookie')) {
     ...
     * @return \QuantaQuirk\Cookie\CookieJar|\Symfony\Component\HttpFoundation\Cookie
     */
...
if (! function_exists('csrf_field')) {
     ...
     *
     * @return \QuantaQuirk\Support\HtmlString
     */
    function csrf_field()
    {
...
if (! function_exists('logger')) {
     ...
     * @param  array  $context
     * @return \QuantaQuirk\Log\LogManager|null
     */
...
if (! function_exists('logs')) {
     ...
     * @return \QuantaQuirk\Log\LogManager|\Psr\Log\LoggerInterface
     */
...
if (! function_exists('mix')) {
     ...
     * @return \QuantaQuirk\Support\HtmlString|string
     *
     * @throws \Exception
     */
...
if (! function_exists('redirect')) {
     ...
     * @param  array  $headers
     * @param  bool|null  $secure
     * @return \QuantaQuirk\Routing\Redirector|\QuantaQuirk\Http\RedirectResponse
     */
...
if (! function_exists('request')) {
     ...
     * @param  array|string|null  $key
     * @param  mixed  $default
     * @return mixed|\QuantaQuirk\Http\Request|string|array|null
     */
...
if (! function_exists('response')) {
     ...
     *
     * @param  \QuantaQuirk\Contracts\View\View|string|array|null  $content
     * @param  int  $status
     * @param  array  $headers
     * @return \QuantaQuirk\Http\Response|\QuantaQuirk\Contracts\Routing\ResponseFactory
     */
...
if (! function_exists('session')) {
     ...
     * @param  array|string|null  $key
     * @param  mixed  $default
     * @return mixed|\QuantaQuirk\Session\Store|\QuantaQuirk\Session\SessionManager
     */
...
if (! function_exists('trans')) {
     ...
     * @param  array  $replace
     * @param  string|null  $locale
     * @return \QuantaQuirk\Contracts\Translation\Translator|string|array|null
     */
...
if (! function_exists('url')) {
     ...
     * @param  mixed  $parameters
     * @param  bool|null  $secure
     * @return \QuantaQuirk\Contracts\Routing\UrlGenerator|string
     */
...
if (! function_exists('validator')) {
     ...
     * @return \QuantaQuirk\Contracts\Validation\Validator|\QuantaQuirk\Contracts\Validation\Factory
     */
...
if (! function_exists('view')) {
     ...
     * @return \QuantaQuirk\Contracts\View\View|\QuantaQuirk\Contracts\View\Factory
     */
