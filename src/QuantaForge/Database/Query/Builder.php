...
use QuantaForge\Contracts\Database\Query\Builder as BuilderContract;
...
use QuantaForge\Database\Concerns\ExplainsQueries;
...
class Builder implements BuilderContract
{
     ...
     *
     * @var \QuantaForge\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \QuantaForge\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \QuantaForge\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \QuantaForge\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     *
     * @param  \QuantaForge\Database\ConnectionInterface  $connection
     * @param  \QuantaForge\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \QuantaForge\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\QuantaForge\Database\Query\Builder|\QuantaForge\Database\Eloquent\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\QuantaForge\Database\Query\Builder|\QuantaForge\Database\Eloquent\Builder|string  $table
     ...
     *
     * @param  \QuantaForge\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|string  $first
     * @param  string|null  $operator
     * @param  \QuantaForge\Contracts\Database\Query\Expression|string|null  $second
     * @param  string  $type
     * @param  bool  $where
     * @return $this
     */
     ...
     * @param  \QuantaForge\Contracts\Database\Query\Expression|string  $second
     * @param  string  $type
     * @return $this
     */
     ...
     *
     * @param  \QuantaForge\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \QuantaForge\Database\Query\JoinClause
     */
     ...
     *
     * @param  \Closure|string|array|\QuantaForge\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \QuantaForge\Contracts\Database\Query\Expression|string  $column
     * @param  mixed  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @param  string  $column
     * @param  \QuantaForge\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\QuantaForge\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\QuantaForge\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  \QuantaForge\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     * @param  \QuantaForge\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure||\QuantaForge\Database\Query\Builder|\QuantaForge\Database\Eloquent\Builder  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  array|\QuantaForge\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \QuantaForge\Contracts\Database\Query\Expression|\Closure|string  $column
     ...
     *
     * @param  \Closure|\QuantaForge\Database\Query\Builder|\QuantaForge\Database\Eloquent\Builder|\QuantaForge\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\QuantaForge\Database\Query\Builder|\QuantaForge\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\QuantaForge\Database\Query\Builder|\QuantaForge\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\QuantaForge\Database\Query\Builder|\QuantaForge\Database\Eloquent\Builder  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \QuantaForge\Database\RecordsNotFoundException
     * @throws \QuantaForge\Database\MultipleRecordsFoundException
     */
     ...
     * @return \QuantaForge\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \QuantaForge\Contracts\Pagination\Paginator
     */
     ...
     * @param  \QuantaForge\Pagination\Cursor|string|null  $cursor
     * @return \QuantaForge\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @return \QuantaForge\Support\LazyCollection
     */
     ...
     *
     * @param  \QuantaForge\Contracts\Database\Query\Expression|string  $columns
     * @return int
     */
     ...
     *
     * @param  mixed  $value
     * @return \QuantaForge\Contracts\Database\Query\Expression
     */
     ...
     *
     * @return \QuantaForge\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \QuantaForge\Database\Query\Grammars\Grammar
     */
