...
use QuantaForge\Database\Concerns\CompilesJsonPaths;
use QuantaForge\Database\Connection;
use QuantaForge\Database\Grammar as BaseGrammar;
...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \QuantaForge\Support\Fluent  $column
     * @return string
     */
     ...
     * @param  \QuantaForge\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \QuantaForge\Support\Fluent|null
     */
     ...
     *
     * @param  \QuantaForge\Support\Fluent|\QuantaForge\Contracts\Database\Query\Expression|string  $value
