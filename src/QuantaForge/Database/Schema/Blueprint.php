...
class Blueprint
{
     ...
     *
     * @var \QuantaForge\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \QuantaForge\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @return \QuantaForge\Support\Fluent
     */
     ...
     * @return \QuantaForge\Database\Schema\IndexDefinition
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \QuantaForge\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \QuantaForge\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \QuantaForge\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \QuantaForge\Database\Schema\ColumnDefinition  $definition
     * @return \QuantaForge\Database\Schema\ColumnDefinition
     */
