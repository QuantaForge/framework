...
namespace QuantaForge\Database\Migrations;

use Doctrine\DBAL\Schema\SchemaException;
use QuantaForge\Console\View\Components\BulletList;
use QuantaForge\Console\View\Components\Error;
use QuantaForge\Console\View\Components\Info;
use QuantaForge\Console\View\Components\Task;
use QuantaForge\Console\View\Components\TwoColumnDetail;
...
class Migrator
{
     ...
     *
     * @var \QuantaForge\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @var array<string, \QuantaForge\Database\Migrations\Migration|null>
     */
     ...
     *
     * @param  \QuantaForge\Database\Migrations\MigrationRepositoryInterface  $repository
     * @param  \QuantaForge\Database\ConnectionResolverInterface  $resolver
     * @param  \QuantaForge\Filesystem\Filesystem  $files
     * @param  \QuantaForge\Contracts\Events\Dispatcher|null  $dispatcher
     * @return void
     */
     ...
     *
     * @return \QuantaForge\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \QuantaForge\Filesystem\Filesystem
     */
     ...
     *
     * @param  \QuantaForge\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
