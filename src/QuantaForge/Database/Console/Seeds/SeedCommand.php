...
class SeedCommand extends Command
{
     ...
     *
     * @return \QuantaForge\Database\Seeder
     */
    protected function getSeeder()
    {
        ...
        return $this->quantaforge->make($class)
                        ->setContainer($this->quantaforge)
                        ->setCommand($this);
    }
    ...
    protected function getDatabase()
    {
        ...
        return $database ?: $this->quantaforge['config']['database.default'];
    }
