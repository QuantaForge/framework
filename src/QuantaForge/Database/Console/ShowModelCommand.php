...
namespace QuantaForge\Database\Console;
...
class ShowModelCommand extends DatabaseInspectionCommand
{
    ...
    public function handle()
    {
        ...
        try {
            $model = $this->quantaforge->make($class);
    ...
    {
        $listeners = $this->getQuantaForge()->make('events')->getRawListeners();
     ...
     * @param  string  $table
     * @param  string  $policy
     * @param  \QuantaForge\Support\Collection  $attributes
     * @param  \QuantaForge\Support\Collection  $relations
     * @param  \QuantaForge\Support\Collection  $observers
     * @return void
     */
     ...
     * @return string
     *
     * @see \QuantaForge\Console\GeneratorCommand
     */
    protected function qualifyModel(string $model)
    {
        ...
        $rootNamespace = $this->quantaforge->getNamespace();
