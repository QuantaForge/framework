...
abstract class Grammar
{
     ...
     *
     * @param  \QuantaForge\Contracts\Database\Query\Expression|string  $value
     ...
     *
     * @param  \QuantaForge\Contracts\Database\Query\Expression|string|int|float  $expression
     ...
     *
     * @param  \QuantaForge\Database\Connection  $prefix
     * @return $this
     */
