...
/**
 * @method static \QuantaForge\Database\Eloquent\Builder|\QuantaForge\Database\Query\Builder withTrashed(bool $withTrashed = true)
 * @method static \QuantaForge\Database\Eloquent\Builder|\QuantaForge\Database\Query\Builder onlyTrashed()
 * @method static \QuantaForge\Database\Eloquent\Builder|\QuantaForge\Database\Query\Builder withoutTrashed()
 */
trait SoftDeletes
{
    /**
