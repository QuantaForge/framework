...
namespace QuantaForge\Database\Eloquent\Factories;
...
use QuantaForge\Support\Enumerable;
...
/**
 * @template TModel of \QuantaForge\Database\Eloquent\Model
 *
 * @method $this trashed()
 */
abstract class Factory
{
     ...
     * @param  \QuantaForge\Support\Collection|null  $states
     * @param  \QuantaForge\Support\Collection|null  $has
     * @param  \QuantaForge\Support\Collection|null  $for
     * @param  \QuantaForge\Support\Collection|null  $afterMaking
     * @param  \QuantaForge\Support\Collection|null  $afterCreating
     * @param  string|null  $connection
     * @param  \QuantaForge\Support\Collection|null  $recycle
     * @return void
     */
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \QuantaForge\Database\Eloquent\Model|null  $parent
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @return \QuantaForge\Database\Eloquent\Model|TModel
     */
     ...
     * @return \QuantaForge\Database\Eloquent\Collection<int, \QuantaForge\Database\Eloquent\Model|TModel>
     */
     ...
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \QuantaForge\Database\Eloquent\Model|null  $parent
     * @return \QuantaForge\Database\Eloquent\Collection<int, \QuantaForge\Database\Eloquent\Model|TModel>|\QuantaForge\Database\Eloquent\Model|TModel
     */
     ...
     * @param  \QuantaForge\Database\Eloquent\Model|null  $parent
     * @return \Closure(): (\QuantaForge\Database\Eloquent\Collection<int, \QuantaForge\Database\Eloquent\Model|TModel>|\QuantaForge\Database\Eloquent\Model|TModel)
     */
     ...
     *
     * @param  \QuantaForge\Support\Collection  $results
     * @return void
     */
     ...
     *
     * @param  (callable(array<string, mixed>, \QuantaForge\Database\Eloquent\Model|null): array<string, mixed>)|array<string, mixed>  $state
     * @return static
     */
     ...
     *
     * @param  \QuantaForge\Database\Eloquent\Factories\Factory  $factory
     ...
     *
     * @param  \QuantaForge\Database\Eloquent\Factories\Factory|\QuantaForge\Support\Collection|\QuantaForge\Database\Eloquent\Model|array  $factory
     ...
     *
     * @param  \QuantaForge\Database\Eloquent\Factories\Factory|\QuantaForge\Database\Eloquent\Model  $factory
     * @param  string|null  $relationship
     * @return static
     */
     ...
     *
     * @param  \QuantaForge\Database\Eloquent\Model|\QuantaForge\Support\Collection|array  $model
     * @return static
     */
     ...
     * @return \QuantaForge\Database\Eloquent\Model|null
     */
     ...
     *
     * @param  \Closure(\QuantaForge\Database\Eloquent\Model|TModel): mixed  $callback
     * @return static
     */
     ...
     *
     * @param  \QuantaForge\Support\Collection  $instances
     * @return void
     */
     ...
     *
     * @return class-string<\QuantaForge\Database\Eloquent\Model|TModel>
     */
     ...
     *
     * @param  callable(self): class-string<\QuantaForge\Database\Eloquent\Model|TModel>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<\QuantaForge\Database\Eloquent\Model>  $modelName
     * @return \QuantaForge\Database\Eloquent\Factories\Factory
     */
     ...
     *
     * @param  callable(class-string<\QuantaForge\Database\Eloquent\Model>): class-string<\QuantaForge\Database\Eloquent\Factories\Factory>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<\QuantaForge\Database\Eloquent\Model>  $modelName
     * @return class-string<\QuantaForge\Database\Eloquent\Factories\Factory>
     */
