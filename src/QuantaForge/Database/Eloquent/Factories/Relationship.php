...
use QuantaForge\Database\Eloquent\Relations\HasOneOrMany;
use QuantaForge\Database\Eloquent\Relations\MorphOneOrMany;
...
class Relationship
{
     ...
     *
     * @var \QuantaForge\Database\Eloquent\Factories\Factory
     */
    protected $factory;
     ...
     *
     * @param  \QuantaForge\Support\Collection  $recycle
     * @return $this
     */
