...
use QuantaForge\Database\Eloquent\Relations\Concerns\ComparesRelatedModels;
use QuantaForge\Database\Eloquent\Relations\Concerns\InteractsWithDictionary;
use QuantaForge\Database\Eloquent\Relations\Concerns\SupportsDefaultModels;
...
class BelongsTo extends Relation
{
     ...
     *
     * @param  \QuantaForge\Database\Eloquent\Model|int|string|null  $model
