...
class HasManyThrough extends Relation
{
     ...
     * @param  \QuantaForge\Database\Eloquent\Model  $farParent
     * @param  \QuantaForge\Database\Eloquent\Model  $throughParent
     ...
     *
     * @return \QuantaForge\Database\Eloquent\Relations\HasOneThrough
     */
    public function one()
    {
    ...
    protected function buildDictionary(Collection $results)
    {
        ...
        foreach ($results as $result) {
            $dictionary[$result->quantaforge_through_key][] = $result;
        }
    ...
    protected function shouldSelect(array $columns = ['*'])
    {
        ...
        return array_merge($columns, [$this->getQualifiedFirstKeyName().' as quantaforge_through_key']);
    }
