...
use Closure;
use Exception;
use QuantaForge\Contracts\Database\Eloquent\Builder as BuilderContract;
...
use QuantaForge\Database\Eloquent\Concerns\QueriesRelationships;
 ...
 *
 * @mixin \QuantaForge\Database\Query\Builder
 */
class Builder implements BuilderContract
{
     ...
     *
     * @var \QuantaForge\Database\Query\Builder
     */
    protected $query;
     ...
     * @return \QuantaForge\Database\Eloquent\Model|static
     */
     ...
     * @param  \QuantaForge\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \QuantaForge\Database\Eloquent\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \QuantaForge\Database\Eloquent\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\QuantaForge\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\QuantaForge\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \QuantaForge\Database\Eloquent\Collection
     */
     ...
     * @return \QuantaForge\Database\Eloquent\Model|\QuantaForge\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     *
     * @param  \QuantaForge\Contracts\Support\Arrayable|array  $ids
     * @param  array|string  $columns
     * @return \QuantaForge\Database\Eloquent\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return \QuantaForge\Database\Eloquent\Model|\QuantaForge\Database\Eloquent\Collection|static|static[]
     *
     ...
     * @return \QuantaForge\Database\Eloquent\Model|\QuantaForge\Database\Eloquent\Collection|static[]|static|mixed
     */
     ...
     * @param  \Closure|array|string  $columns
     * @param  \Closure|null  $callback
     * @return \QuantaForge\Database\Eloquent\Model|static|mixed
     */
     ...
     *
     * @param  array|string  $columns
     * @return \QuantaForge\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \QuantaForge\Database\Eloquent\Relations\Relation
     */
     ...
     *
     * @param  array  $attributes
     * @return \QuantaForge\Database\Eloquent\Model|$this
     */
     ...
     *
     * @param  array|\QuantaForge\Contracts\Database\Query\Expression  $columns
     * @return array
     */
