...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     * @return $this
     *
     * @throws \QuantaForge\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \QuantaForge\Database\Eloquent\Collection<int, static>
     */
     ...
     *
     * @param  \QuantaForge\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     * @return \QuantaForge\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \QuantaForge\Database\Eloquent\JsonEncodingException
     */
     ...
     *
     * @param  \QuantaForge\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \QuantaForge\Database\ConnectionResolverInterface|null
     */
     ...
     *
     * @param  \QuantaForge\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \QuantaForge\Database\Eloquent\Model|\QuantaForge\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \QuantaForge\Database\Eloquent\Relations\Relation
     */
