...
use Closure;
use QuantaForge\Database\Eloquent\Scope;
...
trait HasGlobalScopes
{
     ...
     *
     * @param  \QuantaForge\Database\Eloquent\Scope|\Closure|string  $scope
     * @param  \QuantaForge\Database\Eloquent\Scope|\Closure|null  $implementation
     * @return mixed
     *
     ...
     *
     * @param  \QuantaForge\Database\Eloquent\Scope|string  $scope
     * @return \QuantaForge\Database\Eloquent\Scope|\Closure|null
     */
