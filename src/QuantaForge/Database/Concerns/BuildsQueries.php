...
trait BuildsQueries
{
     ...
     * @return \QuantaForge\Database\Eloquent\Model|object|static|null
     */
     ...
     *
     * @param  \QuantaForge\Database\Query\Builder|\QuantaForge\Database\Eloquent\Builder  $builder
     ...
     *
     * @param  \QuantaForge\Support\Collection  $items
     * @param  int  $total
     * @param  int  $perPage
     * @param  int  $currentPage
     * @param  array  $options
     * @return \QuantaForge\Pagination\LengthAwarePaginator
     */
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \QuantaForge\Pagination\Paginator
     */
     ...
     * @param  \QuantaForge\Support\Collection  $items
     * @param  int  $perPage
     * @param  \QuantaForge\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \QuantaForge\Pagination\CursorPaginator
     */
