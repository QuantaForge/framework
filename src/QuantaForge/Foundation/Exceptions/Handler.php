...
namespace QuantaForge\Foundation\Exceptions;
...
use QuantaForge\Cache\RateLimiting\Unlimited;
use QuantaForge\Console\View\Components\BulletList;
use QuantaForge\Console\View\Components\Error;
...
class Handler implements ExceptionHandlerContract
{
     ...
     *
     * @var \QuantaForge\Foundation\Exceptions\ReportableHandler[]
     */
    ...
    protected function shouldntReport(Throwable $e)
    {
        ...
        return rescue(fn () => with($this->throttle($e), function ($throttle) use ($e) {
            ...
            return ! $this->container->make(RateLimiter::class)->attempt(
                with($throttle->key ?: 'quantaforge:foundation:exceptions:'.$e::class, fn ($key) => $this->hashThrottleKeys ? md5($key) : $key),
     ...
     *
     * @param  \Throwable  $e
     * @return \QuantaForge\Support\Lottery|\QuantaForge\Cache\RateLimiting\Limit|null
     */
     ...
     * @param  \QuantaForge\Http\Request  $request
     * @param  \Throwable  $e
     * @return \QuantaForge\Http\Response|\QuantaForge\Http\JsonResponse|\QuantaForge\Http\RedirectResponse
     */
     ...
     *
     * @param  \QuantaForge\Http\Request  $request
     * @param  \QuantaForge\Auth\AuthenticationException  $exception
     * @return \QuantaForge\Http\Response|\QuantaForge\Http\JsonResponse|\QuantaForge\Http\RedirectResponse
     */
     ...
     *
     * @param  \QuantaForge\Validation\ValidationException  $e
     * @param  \QuantaForge\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \QuantaForge\Http\Request  $request
     * @param  \QuantaForge\Validation\ValidationException  $exception
     * @return \QuantaForge\Http\Response|\QuantaForge\Http\JsonResponse|\QuantaForge\Http\RedirectResponse
     */
    ...
    protected function prepareResponse($request, Throwable $e)
    {
        if (! $this->isHttpException($e) && config('app.debug')) {
            return $this->toQuantaForgeResponse($this->convertExceptionToResponse($e), $e)->prepare($request);
        }
        ...
        return $this->toQuantaForgeResponse(
    ...
    /**
     * Map the given exception into an QuantaForge response.
     *
     * @param  \Symfony\Component\HttpFoundation\Response  $response
     * @param  \Throwable  $e
     * @return \QuantaForge\Http\Response|\QuantaForge\Http\RedirectResponse
     */
    protected function toQuantaForgeResponse($response, Throwable $e)
    {
