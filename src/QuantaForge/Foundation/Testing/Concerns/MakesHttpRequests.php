...
use QuantaForge\Contracts\Http\Kernel as HttpKernel;
use QuantaForge\Cookie\CookieValuePrefix;
use QuantaForge\Http\Request;
use QuantaForge\Testing\LoggedExceptionCollection;
...
trait MakesHttpRequests
{
     ...
     *
     * @var \QuantaForge\Testing\TestResponse|null
     */
     ...
     * @param  string  $uri
     * @param  array  $headers
     * @return \QuantaForge\Testing\TestResponse
     */
     ...
     *
     * @param  \QuantaForge\Http\Response|\QuantaForge\Testing\TestResponse  $response
     * @return \QuantaForge\Http\Response|\QuantaForge\Testing\TestResponse
     */
