...
use QuantaForge\Support\Facades\View as ViewFacade;
use QuantaForge\Support\MessageBag;
use QuantaForge\Support\ViewErrorBag;
use QuantaForge\Testing\TestComponent;
use QuantaForge\Testing\TestView;
...
trait InteractsWithViews
{
     ...
     * @return \QuantaForge\Testing\TestView
     */
    ...
    protected function blade(string $template, $data = [])
    {
        ...
        $tempFileInfo = pathinfo(tempnam($tempDirectory, 'quantaforge-blade'));
     ...
     * @param  \QuantaForge\Contracts\Support\Arrayable|array  $data
     * @return \QuantaForge\Testing\TestComponent
     */
