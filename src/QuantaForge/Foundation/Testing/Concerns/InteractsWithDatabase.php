...
use QuantaForge\Testing\Constraints\CountInDatabase;
use QuantaForge\Testing\Constraints\HasInDatabase;
use QuantaForge\Testing\Constraints\NotSoftDeletedInDatabase;
use QuantaForge\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param  \QuantaForge\Database\Eloquent\Model|string  $table
     * @param  array  $data
