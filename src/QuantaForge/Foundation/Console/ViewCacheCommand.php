...
class ViewCacheCommand extends Command
{
     ...
     *
     * @param  \QuantaForge\Support\Collection  $views
     * @return void
     */
    protected function compileViews(Collection $views)
    {
        $compiler = $this->quantaforge['view']->getEngineResolver()->resolve('blade')->getCompiler();
    ...
    {
        $extensions = collect($this->quantaforge['view']->getExtensions())
    ...
    {
        $finder = $this->quantaforge['view']->getFinder();
