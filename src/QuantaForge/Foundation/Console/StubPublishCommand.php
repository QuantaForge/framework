...
use QuantaForge\Foundation\Events\PublishingStubs;
...
class StubPublishCommand extends Command
{
    ...
    {
        if (! is_dir($stubsPath = $this->quantaforge->basePath('stubs'))) {
        ...
        $this->quantaforge['events']->dispatch($event = new PublishingStubs($stubs));
