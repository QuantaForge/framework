...
class ChannelListCommand extends Command
{
     ...
     *
     * @param  \QuantaForge\Contracts\Broadcasting\Broadcaster
     * @return void
     */
    public function handle(Broadcaster $broadcaster)
    {
        ...
        if (! $this->quantaforge->providerIsLoaded('App\Providers\BroadcastServiceProvider') &&
            file_exists($this->quantaforge->path('Providers/BroadcastServiceProvider.php'))) {
     ...
     *
     * @param  \QuantaForge\Support\Collection  $channels
     * @return array
     */
