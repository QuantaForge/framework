...
use QuantaForge\Console\Application as Artisan;
...
use QuantaForge\Contracts\Console\Kernel as KernelContract;
...
class Kernel implements KernelContract
{
     ...
     *
     * @var \QuantaForge\Console\Application|null
     */
    protected $artisan;
    ...
    protected $bootstrappers = [
        ...
        \QuantaForge\Foundation\Bootstrap\SetRequestForConsole::class,
    ...
    /**
     * Re-route the Symfony command events to their QuantaForge counterparts.
     *
     * @internal
     *
     * @return $this
     ...
     * @return \QuantaForge\Foundation\Console\ClosureCommand
     */
    ...
    public function bootstrapWithoutBootingProviders()
    {
        $this->app->bootstrapWith(
            collect($this->bootstrappers())->reject(function ($bootstrapper) {
                return $bootstrapper === \QuantaForge\Foundation\Bootstrap\BootProviders::class;
            })->all()
        );
    }
     ...
     *
     * @return \QuantaForge\Console\Application
     */
     ...
     *
     * @param  \QuantaForge\Console\Application|null  $artisan
     * @return void
     */
