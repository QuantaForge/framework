...
use QuantaForge\Foundation\Support\Providers\EventServiceProvider;
...
class EventCacheCommand extends Command
{
    ...
    public function handle()
    {
        ...
        file_put_contents(
            $this->quantaforge->getCachedEventsPath(),
    ...
    protected function getEvents()
    {
        ...
        foreach ($this->quantaforge->getProviders(EventServiceProvider::class) as $provider) {
