...
use QuantaForge\Broadcasting\Broadcasters\LogBroadcaster;
use QuantaForge\Broadcasting\Broadcasters\NullBroadcaster;
...
use QuantaForge\Contracts\Broadcasting\Factory as FactoryContract;
...
/**
 * @mixin \QuantaForge\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param  \QuantaForge\Contracts\Container\Container  $app
     * @return void
     */
    ...
    public function routes(array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\QuantaForge\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
