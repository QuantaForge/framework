...
namespace QuantaForge\Broadcasting\Broadcasters;

use Closure;
use Exception;
use QuantaForge\Container\Container;
use QuantaForge\Contracts\Broadcasting\Broadcaster as BroadcasterContract;
...
abstract class Broadcaster implements BroadcasterContract
{
     ...
     *
     * @var \QuantaForge\Contracts\Routing\BindingRegistrar
     */
     ...
     *
     * @param  \QuantaForge\Contracts\Broadcasting\HasBroadcastChannel|string  $channel
     ...
     *
     * @return \QuantaForge\Contracts\Routing\BindingRegistrar
     */
