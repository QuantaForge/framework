...
class DatabaseBatchRepository implements PrunableBatchRepository
{
     ...
     *
     * @var \QuantaForge\Bus\BatchFactory
     */
    protected $factory;
     ...
     *
     * @param  \QuantaForge\Bus\BatchFactory  $factory
     ...
     *
     * @param  \QuantaForge\Bus\PendingBatch  $batch
     * @return \QuantaForge\Bus\Batch
     */
     ...
     * @param  string  $batchId
     * @param  string  $jobId
     * @return \QuantaForge\Bus\UpdatedBatchJobCounts
     */
