...
trait ConfiguresPrompts
{
    ...
    protected function configurePrompts(InputInterface $input)
    {
        ...
        Prompt::interactive(($input->isInteractive() && defined('STDIN') && stream_isatty(STDIN)) || $this->quantaforge->runningUnitTests());

        Prompt::fallbackWhen(windows_os() || $this->quantaforge->runningUnitTests());
