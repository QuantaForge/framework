...
class ScheduleListCommand extends Command
{
     ...
     *
     * @param  \QuantaForge\Support\Collection  $events
     ...
     */
    private function sortEvents(\QuantaForge\Support\Collection $events, DateTimeZone $timezone)
    {
     ...
     *
     * @param  \QuantaForge\Console\Scheduling\CallbackEvent  $event
     * @return string
     */
    private function getClosureLocation(CallbackEvent $event)
    {
        ...
        if ($callback instanceof Closure) {
            ...
            return sprintf(
                '%s:%s',
                str_replace($this->quantaforge->basePath().DIRECTORY_SEPARATOR, '', $function->getFileName() ?: ''),
