...
use QuantaForge\Console\Concerns\CreatesMatchingTest;
...
abstract class GeneratorCommand extends Command implements PromptsForMissingInput
{
     ...
     * @return bool|null
     *
     * @throws \QuantaForge\Contracts\Filesystem\FileNotFoundException
     */
    ...
    protected function getPath($name)
    {
        ...
        return $this->quantaforge['path'].'/'.str_replace('\\', '/', $name).'.php';
    }
    ...
    {
        return $this->quantaforge->getNamespace();
    }
    ...
    {
        $config = $this->quantaforge['config'];
    ...
    {
        $views = $this->quantaforge['config']['view.paths'][0] ?? resource_path('views');
