...
use Closure;
use QuantaForge\Console\Events\ArtisanStarting;
use QuantaForge\Contracts\Console\Application as ApplicationContract;
...
class Application extends SymfonyApplication implements ApplicationContract
{
     ...
     * @return void
     */
    public function __construct(Container $quantaforge, Dispatcher $events, $version)
    {
        parent::__construct('QuantaForge Framework', $version);
    ...
    protected function parseCommand($command, $parameters)
    {
        if (is_subclass_of($command, SymfonyCommand::class)) {
            ...
            $command = $this->quantaforge->make($command)->getName();
        }
    ...
    public function add(SymfonyCommand $command)
    {
        if ($command instanceof Command) {
            $command->setQuantaForge($this->quantaforge);
        }
     ...
     *
     * @param  \QuantaForge\Console\Command|string  $command
    ...
    public function resolve($command)
    {
        ...
        return $this->add($this->quantaforge->make($command));
    }
    ...
    {
        $this->setCommandLoader(new ContainerCommandLoader($this->quantaforge, $this->commandMap));
