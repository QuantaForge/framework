...
use QuantaForge\Cache\DynamoDbStore;
use QuantaForge\Contracts\Cache\Factory as Cache;
...
class CacheCommandMutex implements CommandMutex
{
     ...
     *
     * @param  \QuantaForge\Contracts\Cache\Factory  $cache
     */
     ...
     *
     * @param  \QuantaForge\Console\Command  $command
     * @return bool
     */
