...
namespace QuantaForge\Filesystem;

use Closure;
use QuantaForge\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use QuantaForge\Contracts\Filesystem\Filesystem as FilesystemContract;
use QuantaForge\Http\File;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @param  string  $path
     * @param  \Psr\Http\Message\StreamInterface|\QuantaForge\Http\File|\QuantaForge\Http\UploadedFile|string|resource  $contents
     * @param  mixed  $options
     * @return string|bool
     */
     ...
     *
     * @param  \QuantaForge\Http\File|\QuantaForge\Http\UploadedFile|string  $path
     * @param  \QuantaForge\Http\File|\QuantaForge\Http\UploadedFile|string|array|null  $file
     * @param  mixed  $options
     * @return string|false
     */
