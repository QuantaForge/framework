...
use Closure;
use QuantaForge\Contracts\Auth\Factory as FactoryContract;
use InvalidArgumentException;

/**
 * @mixin \QuantaForge\Contracts\Auth\Guard
 * @mixin \QuantaForge\Contracts\Auth\StatefulGuard
 */
class AuthManager implements FactoryContract
{
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \QuantaForge\Auth\SessionGuard
     */
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \QuantaForge\Auth\TokenGuard
     */
